      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            onClick={() =>
              window.open('https://github.com/mertgoevse-wq/VELDRA/issues/new?template=bug_report.yml', '_blank')
            }
          >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://github.com/mertgoevse-wq/VELDRA', '_blank')}
          >
