...
import { SkinPicker } from '~/components/@settings/shared/components/SkinPicker';
...
export default function SettingsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        className="bg-bolt-elements-background-depth-1 rounded-lg shadow-sm dark:shadow-none p-4 space-y-4"
      ...
      {/* Timezone */}
      <motion.div
        className="bg-bolt-elements-background-depth-1 rounded-lg shadow-sm dark:shadow-none p-4"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between p-2 rounded-lg bg-bolt-elements-background-depth-2">
            ...
            <div className="flex items-center gap-1">
              <kbd className="px-2 py-1 text-xs font-semibold text-bolt-elements-textSecondary bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor rounded shadow-sm">
