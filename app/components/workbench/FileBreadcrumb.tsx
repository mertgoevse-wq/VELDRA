                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] w-full min-w-0 sm:min-w-[300px] max-w-[90vw] overflow-scroll bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
