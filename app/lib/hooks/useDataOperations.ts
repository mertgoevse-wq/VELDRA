...
export function useDataOperations({
  ...
  const handleExportSettings = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = 'veldra-settings.json';
  ...
  const handleExportSelectedSettings = useCallback(
    async (categoryIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = `veldra-settings-${categoryIds.join('-')}.json`;
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleExportSelectedChats = useCallback(
    async (chatIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'veldra-selected-chats.json';
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleDownloadTemplate = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'veldra-api-keys-template.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const handleExportAPIKeys = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'veldra-api-keys.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
