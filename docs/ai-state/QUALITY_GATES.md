...
npm test                  # vitest run — 395 passing as of 2026-08-15 (later round); run
                           # this, don't just cite a stale count from a doc (see
                           # DECISIONS.md/current-session.md 2026-08-15: 9 pre-existing
                           # failures across 2 files were sitting undiscovered before this)
